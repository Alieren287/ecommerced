...
/**
 * Value object representing product attributes (e.g., brand, material, color, size).
 */
@Getter
@ToString
...
public class ProductAttributes extends ValueObject {
    ...
    /**
     * Creates ProductAttributes from a map.
     */
    ...
    /**
     * Creates empty ProductAttributes.
     */
    public static ProductAttributes empty() {
        return new ProductAttributes(Collections.emptyMap());
    }
    ...
    protected void validate() {
        require(attributes != null, "Product attributes cannot be null");
        ...
        require(attributes.size() <= 30, "Cannot have more than 30 attributes per product");
    }
} 