...
import com.devcart.productservice.product.infrastructure.web.dto.UpdateTagsRequest;
...
public class ProductTagController {
    ...
    public ResponseEntity<?> updateTags(@PathVariable UUID productId, @RequestBody UpdateTagsRequest request) {
        try {
            UpdateTagsCommand command = new UpdateTagsCommand(productId, request.getTags());
