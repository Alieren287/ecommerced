...
@Getter
public class ProductVariantDeactivatedEvent implements DomainEvent {
    ...
    public ProductVariantDeactivatedEvent(ProductId productId, ProductVariantId variantId, LocalDateTime occurredOn) {
    ...
    public String getEventType() {
        return "ProductVariantDeactivated";
    }
}
