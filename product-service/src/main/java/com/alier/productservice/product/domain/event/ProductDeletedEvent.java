...
public class ProductDeletedEvent implements DomainEvent {
    ...
    public ProductDeletedEvent(ProductId productId, ProductName productName, LocalDateTime occurredOn) {
    ...
    public ProductDeletedEvent(ProductId productId, ProductName productName) {
