...
import com.alier.productservice.product.infrastructure.web.dto.UpdateCategoriesRequest;
...
public class ProductCategoryController {
    ...
    public ResponseEntity<?> updateCategories(@PathVariable UUID productId, @RequestBody UpdateCategoriesRequest request) {
        try {
            UpdateCategoriesCommand command = new UpdateCategoriesCommand(productId, request.categoryIds());
